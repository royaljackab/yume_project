...
#define Task_beginContext                                                      \
  struct Task_contextTag {                                                     \
    int Task_line;                                                             \
    int Task_wait
#define Task_endContext(x)                                                     \
  }                                                                            \
  *x = (struct Task_contextTag *)*Task_param

#define Task_begin(x)                                                          \
  if (!x) {                                                                    \
    x = *Task_param = calloc(1, sizeof(*x));                                   \
    x->Task_line = 0;                                                          \
    x->Task_wait = 0;                                                          \
  }                                                                            \
  if (x)                                                                       \
